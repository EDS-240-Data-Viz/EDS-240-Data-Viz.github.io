...
1.Download the `stressor.csv` here[https://drive.google.com/file/d/1T4cOrd6Fyyq-iep6Jg_6sFjmO-yYX1oK/view?usp=drive_link]. [**Load the `{tidyverse}` and `{janitor}`  packages, and read in `stressor.csv`. Perform some basic data exploration.**]{.teal-text} Use the `{here}` package to read in your data and check out things like the dimensions, structure, types of variables, unique observations, etc. Read through the [metadata](https://esmis.nal.usda.gov/sites/default/release-files/rn301137d/8g84nk42x/00000x890/hcny0821.pdf){target="_blank"}. This data came from [tidytuesday](https://github.com/rfordatascience/tidytuesday/tree/main/data/2022/2022-01-11). In an effort to provide a data wrangling activity, the data was messified using the `messy` package in R. 
