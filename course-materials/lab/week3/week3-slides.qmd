...
[EDS 240: Lab 3]{.custom-title}

[*Alt Text*]{.custom-subtitle}

<hr class="hr-dark-blue">

[Week 3 | January 21^st^, 2025]{.custom-subtitle3}
...
[[WebAIM](https://webaim.org/){target="_blank"} defines alternative text, aka alt text, as:]{.body-text-m} 
...
Data viz designer and instructor, [Amy Cesal](https://www.amycesal.com/){target="_blank"}, suggests this rule of thumb for writing alt text for data visualizations: **alt=“[Chart type]{style="background-color:#FFE600"} of [type of data]{style="background-color:#6DFFF8"} where [reason for including chart]{style="background-color:#74FF75"}**.
...
knitr::include_graphics(here::here("course-materials", "images", "lab-materials", "hawkins-warming-stripes.png"))
```
...
::: footer
[Example from [Amy Cesal](https://www.amycesal.com/){target="_blank"}'s article, [Writing Alt Text for Data Visualization](https://nightingaledvs.com/writing-alt-text-for-data-visualization/){target="_blank"}]{.gray-text}
:::
...
knitr::include_graphics(here::here("course-materials", "images", "lab-materials", "haake-milk.png"))
```
...
::: footer
[Example from [Datawrapper](https://academy.datawrapper.de/article/330-how-to-write-good-alternative-descriptions-for-your-data-visualization){target="_blank"}]{.gray-text}
:::
...
::: {.column width="50%"}
[**Figure caption:**]{.teal-text} "Warming Stripes", by Ed Hawkins, depicts the average annual global temperature from 1850-2022. Data Source: [HadCRUT5](https://www.metoffice.gov.uk/hadobs/hadcrut5/){target="_blank"}. To learn more about this visualization, visit [showyourstripes.info](https://showyourstripes.info/){target="_blank"}.
...
- **carefully consider the use of special characters** ([this article](https://www.elevenways.be/en/articles/screenreaders-special-characters){target="_blank"} details "safe" vs. "unread" characters)
...
<!-- ::: footer -->
<!-- Data source: [`{palmerpenguins}`](https://allisonhorst.github.io/palmerpenguins/) -->
<!-- ::: -->
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lab-materials", "check-alt-text.png"))
```
