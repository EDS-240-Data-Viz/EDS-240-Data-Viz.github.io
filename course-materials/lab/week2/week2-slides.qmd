...
**This week, we'll focus on the data layer, geometric layer, and scales.** During week 4 lab, we'll work on tweaking the theme (all non-data elements) to get it to look just like the U.S. Drought Monitor's version.
