...
[EDS 240: Lab 9]{.custom-title}

[*Peer feedback*]{.custom-subtitle}

<hr class="hr-dark-blue">

[Week 9 | March 5^th^, 2026]{.custom-subtitle3}
...
[Peer Feedback Round 1:]{.slide-title}

With your Round 1 Partner: 

<hr>

1. Take 5 minutes to review your partner's viz and jot down (in the [peer evaluation feedback form](https://docs.google.com/document/d/1xV-YF5PyfoZA_HXmiHC2NqaS5t5tTb8C_AtndsoM0JA/edit?tab=t.0) ):
...
[In the last ~60 minutes of section, we'll do a rapid fire share out of feedback. Please be prepared to share with the class:]{.body-text-m}
...
## {#data-humanism data-menu-title="Data Humanism"}
...
{{< video https://www.youtube.com/watch?v=rr_P1rdj_Zk width="100%" height="65%" >}}

::: {.footer}
Watch this on your own time!
:::

<!-- https://www.youtube.com/results?search_query=Giorgia+Lupi%3A+How+we+can+find+ourselves+in+data+ -->

<!-- https://www.ted.com/talks/chris_jordan_turning_powerful_stats_into_art?referrer=playlist-making_sense_of_too_much_data&autoplay=true&subtitle=en -->
