...
::: {.callout-note}
It's up to you to organize your own `week2-lab.qmd` file (i.e. there is no template). You may (should) discuss and work through today's exercise with a partner (or two!).
:::

1. Begin by copying the following setup and data wrangling code into your `week2-lab.qmd` file. Run through and review the code, and explore the resulting `drought_clean` data frame.
