...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 3.1: visualizing amounts / rankings](lecture-slides/SLIDES-amounts-rankings.qmd){target="_blank"}  | [3.1 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-amounts-rankings.qmd){target="_blank"} | [3.1 key](keys/KEY-amounts-rankings.qmd){target="_blank"} |
| [Lecture 3.2: visualizing evolution](lecture-slides/SLIDES-evolution.qmd){target="_blank"}  | [3.2 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-evolution.qmd){target="_blank"} | [3.2 key](keys/KEY-evolution.qmd){target="_blank"} |
: {.hover .bordered tbl-colwidths="[50,25,25]"} 

## {{< fa clipboard-list title="a clipboard with a To Do list" >}} Pre-lab Prep {#pre-lab-prep} 

### A. Download data {#download-data}

Head to the [Comprehensive Statistics Download Data](https://droughtmonitor.unl.edu/DmData/DataDownload/ComprehensiveStatistics.aspx) page on the [USDM Website](https://droughtmonitor.unl.edu/). Select the following options, click "Submit", and save the downloaded data to your class repo at `EDS-240-class-examples/week3/data/`

![](images/lab-materials/drought_data_download.png)

 Dataset title | Download link | Notes |
|---------------|---------------|-------|
| US Drought Monitor Comprehensive Statistics | download the .csv file that is generated with the above specifications from the [Comprehensive Statistics Data Download Page](https://droughtmonitor.unl.edu/DmData/DataDownload/ComprehensiveStatistics.aspx) on the [USDM Website](https://droughtmonitor.unl.edu/) *([Google Drive backup link](https://drive.google.com/file/d/1SQOUoCD9RZIpzm2rKyjKenRlMFiCKhny/view?usp=drive_link){target="_blank"}, in case the USDM is unavailable)* | *NA* |
: {.hover .bordered tbl-colwidths="[30,30,30]"} 

### B. Prepare a `week3-lab.qmd` file
...
### C. (OPTIONAL) Install Chrome extension for picking colors
