...
::: {.callout-important}
## TODO
find new place in lecture to show `{scales}` (no longer fits in lecture 3.2)
```{r}
#| eval: false
#| echo: true
...
|-------------------|-------------------|--------------|
| [Lab 3 slides: Alt Text](lab/LAB-SLIDES-alt-text.qmd){target="_blank"} | [Lab 3 exercise: writing alt text](lab/LAB-EXERCISE-alt-text.qmd){target="_blank"} | [Lab 3 solution](lab/LAB-SOLUTION-alt-text.qmd){target="_blank"} |
