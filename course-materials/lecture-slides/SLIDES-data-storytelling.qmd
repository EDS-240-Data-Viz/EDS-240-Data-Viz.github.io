...
The next nine slides (14 - 22) each have a different static visualization. With your learning partner(s), discuss the following:
...
## {#freshwater-fish data-menu-title="Freshwater fish"} 
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "freshwater-fish.png"))
```

::: {.footer}
[Freshwater Biodiversity](https://biodiversitystripes.info/freshwater/fish){target="_blank"} by [biodiversitystripes.info](https://biodiversitystripes.info/global){target="_blank"} & [livingplanetindex.org](https://www.livingplanetindex.org/){target="_blank"}
:::
