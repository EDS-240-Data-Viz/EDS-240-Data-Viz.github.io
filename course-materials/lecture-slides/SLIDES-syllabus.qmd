...
| 6   | 2/11    | infogrpahic design with Affinity                                    |
...
::: {.footer}
<sup>1</sup>Except downloading `.qmd` templates -- please hold off until each Wednesday morning, as changes are likely to occur up until just before class {{< fa face-smile title="a smiling face" >}}
:::
