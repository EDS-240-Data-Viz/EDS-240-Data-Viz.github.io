...
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "bren-hall.jpg"))
```
...
#| fig-align: "center"
#| out-width: "50%" 
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "sam.png"))
```
...
[**Student hours:** Tuesdays 1:00-2:00pm]{.body-text-s}  
:::
...
#| fig-align: "center"
#| out-width: "50%" 
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "annie.png"))
```
...
[**Student hours:** Thursdays 2:00-3:00pm]{.body-text-s} 
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "eds240-website.png"))
```

::: {.body-text-m .center-text}
Please **read the [syllabus](https://docs.google.com/document/d/19Fr6XxobSM7OAdqcpZ7AyZ4qGHO5iLyS6iGEkP4W7SU/edit?tab=t.0){target="_blank"} in full** this week, if you haven't already!
:::

::: {.footer}
Website link is also bookmarked at the top of the **#eds-240-data-viz** Slack channel and on the [Bren website](https://bren.ucsb.edu/courses/eds-240){target="_blank"}.
:::
...
| 2   | 1/14    | graphic Forms, fundamental chart types (distributions)              |
| 3   | 1/21    | fundamental chart types (evolution & amounts / rankings)            |
| 4   | 1/28    | fundamental chart types (relationships), what makes a good viz      |
| 5   | 2/05    | enhancing visualizations (colors)                                   |
| 6   | 2/11    | infographic design with Affinity                                    |
| 7   | 2/18    | enhancing visualizations (typography & annotations)                 |
| 8   | 2/25    | data storytelling, people as data                                   |
| 9   | 3/04    | alternative chart types                                             |
| 10  | 3/11    | tbd, wrap-up                                                        |
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "eds240-website-course-materials.png"))
```
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "pre-lecture-prep.png"))
```

::: {.center-text}
***It is highly recommended that you do this in advance<sup>1</sup> of attending lecture.***
:::

::: {.footer}
<sup>1</sup>I may be making changes to template files ahead of class -- I'll let you know if you need to redownload the latest version, if so {{< fa face-smile title="a smiling face" >}}
:::
...
::: {.incremental}
- **3 Homeworks (HWs)** - assignments where you'll apply conceptual knowledge & technical skills to data viz tasks using instructor-chosen data sets
- **5 Final Project Milestones (FPMs)** - required milestones designed to help you make steady progress on your final project deliverables
...
**PLEASE NOTE:** Your last FPM is an in-person flash talk during finals week (3/19 from 1:00-3:30pm)
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "assignments.png"))
```
:::
::::
...
::: {.center-text .teal-text}
**Start working on HW #1 (due next Wednesday 1/14) & SR #1 (due this Friday 1/9) now!**
:::

---

## {#final-project data-menu-title="Final Project"} 

[Final project sneak peak]{.slide-title}

<hr>

::: {.center-text .teal-text}
**data-driven infographic + blog post + flash talk **
:::
...
#| out-width: "77%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "pepper2025-salmon.png"))
```
:::
...
#| out-width: "72%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "kochuten2025-hoverflies.png"))
```
:::
...
::: {.footer}
Infographics by [Nicole Pepper](https://nicolelpepper.github.io/blogs/2025-03-25-an-upstream-battle/){target="_blank"} (MEDS 2025) & [Marina Kochuten](https://marinakochuten.github.io/blog-posts/hoverflies/){target="_blank"}
:::
...
[{{< fa comment >}}]{.teal-text} if you receive a *Not Yet* mark, you will **receive feedback** from your instructors and have one opportunity to **revise & resubmit at no penalty** to earn a *Satisfactory* mark; your initial submission must be complete
...
[{{< fa cart-shopping >}}]{.teal-text} **trade tokens** for a *second* revision & resubmission attempt and / or 24hr extension on assignments; track & use your tokens using the [EDS 240 Token Dashboard](https://script.google.com/a/macros/ucsb.edu/s/AKfycbx2bFyK5kpsqBlvYgWnQm64YNehPWeFAxl9BqMPoRFjE1MSOkkx_Bf0PkFa1Z6_YkRh/exec){target="_blank"}
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "grade-tracker.png"))
```
...
[[{{< fa people-carry-box >}}]{.teal-text} For both building a collaborative learning community *and* because it mirrors professional expectations (it's also UCSB policy).]{.body-text-m}

<br>

. . . 

[[{{< fa calendar-check >}}]{.teal-text} If you need to miss a class, be proactive and work with your instructors on a catch up plan.]{.body-text-m}

<br>

. . . 

[[{{< fa viruses >}}]{.teal-text} Please stay home if you're sick!]{.body-text-m}

<br>

<!-- . . . 

[[{{< fa flag >}}]{.teal-text} Extended absenses (>2 classes) necessitate us involving academic personnel at Bren.]{.body-text-m} -->
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "slack.png"))
```
:::
...
[A note on expectations]{.slide-title}

<hr>

- We are not mind-readers (as helpful as that would be!). Please help us help you by **bringing any issues to our attention** – the earlier the better!
