...
## {#color-bars-better data-menu-title="Color bars 2"} 

[Don't use color unnecessarily]{.slide-title}

<hr>

The x-axis already identifies each bar, so adding color provides no additional information. Use color intentionally, only when it communicates something meaningful!
...
and_vertebrates |>
  ...
  geom_point(aes(color = species), size = 3) +
  scale_color_manual(values = c("#5B1A18", "#FD6467")) +
  theme_minimal() +
  theme(
    axis.text = element_text(size = 16),
    axis.title = element_text(size = 18),
...
## {#fish-colors2 data-menu-title="Fish colors 2"} 
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "7colors.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "consistent-colors.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "legend.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "use-gray.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "low-high-choropleth.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "lightness-gradient.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "1-or-2-hues.png"))
```
