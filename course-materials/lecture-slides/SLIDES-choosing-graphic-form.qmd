...
[EDS 240: Lecture 2.1]{.custom-title}
...
::: {.right-align-text}
-[Richard H. Thaler](https://faculty.chicagobooth.edu/richard-thaler){target="_blank"}, economist & professor
:::
...
#| fig-align: "center"
#| out-width: "35%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "thaler-exams.png"))
# library(tidyverse)
...
Alberto Cairo's visualization of the scores from Thaler's exam case study, from [The Truthful Art](https://www.amazon.com/gp/product/0321934075/){target="_blank"}
:::
...
::: {.right-align-text}
-Alberto Cairo^1^, in his book, [*The Truthful Art*](https://www.amazon.com/Truthful-Art-Data-Charts-Communication/dp/0321934075){target="_blank"}
:::
...
```{r countdown-mapping-properties}
countdown::countdown(
  minutes = 3,
  # left = 0, right = 0,
...
::: footer
Example adapted from Alberto Cairo's, *The Truthful Art*
:::
...
::: {.column width="50%"}
{{< include sections/map-length-height.qmd >}}
:::

::: {.column width="50%"}
{{< include sections/map-pos-area.qmd >}}
:::
...
::: {.column width="50%"}
{{< include sections/angle.qmd >}}
:::

::: {.column width="50%"}
{{< include sections/color.qmd >}}
:::

::::

::: footer
Graphs recreated based on Alberto Cairo's example (Fig 5.2) in *The Truthful Art*
...
William S. Cleveland & Robert McGill (1984) **Graphical Perception: Theory, Experimentation, and Application to the Development of Graphical Methods**, *Journal of the American Statistical Association*, 79:387, 531-554, DOI: [10.1080/01621459.1984.10478080](https://doi.org/10.1080/01621459.1984.10478080){target="_blank"}
:::
...
[[Alberto Cairo's recreation](https://badriadhikari.github.io/data-viz-workshop-2021/activity-perceptual-task/Solution.html){target="_blank"} of Cleveland & McGill's Hierarchy of Elementary Perceptual Tasks {{< fa arrow-right title="an arrow pointing to the right" >}}]{.body-text-s .gray-text}

:::

::: {.column width="50%"}
```{r cairo-elementary-perception}
#| eval: true
#| echo: false
#| fig-align: "center"
#| out-width: "75%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "cairo-elementary-visual-perception.png"))
```
...
{{< include sections/choropleth.qmd >}}
...
::: {.footer}
Map created using precipitation data from NOAA's [National Centers for Environmental Information](https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/county/mapping/110/pcp/202510/60/value){target="_blank"}.
:::
...
::: {.column width="60%"}
{{< include sections/sankey.qmd >}}
:::

::: {.column width="40%"}
```{r cairo-elementary-perception2}
#| eval: true
#| echo: false
#| out-width: "60%"
#| fig-align: "center"
...
::: {.footer}
Graphic recreated using the [`{networkD3}` package](https://christophergandrud.github.io/networkD3/){target="_blank"} following [Louise E. Sinks'](https://lsinks.github.io/){target="_blank"} blog post, [TidyTuesday: Exploring Refugee Flow with A Sankey Diagram](https://lsinks.github.io/posts/2023-08-28-TidyTuesday-Refugees/TidyTuesday34-refugees.html){target="_blank"}
:::
...
## {#beyond-scatter-plots data-menu-title="Beyond scatter plots"}

[Unique visualizations are important!]{.slide-title2}
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "Bertini-etal.png"))
```

::: {.footer}
Bertini E, Correll M, Franconeri S (2020) [Why Shouldn't All Charts Be Scatter Plots? Beyond Precision-Driven Visualizations](https://arxiv.org/pdf/2008.11310){target="_blank}. IEEE Visualization Conference (VIS), pp 206-210.
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "dtv.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "dvp.png"))
```

::: {.center-text}
[Data Viz Project](https://datavizproject.com/){target="_blank"}
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "vv.png"))
```

::: {.center-text}
[Visual Vocabulary](https://ft-interactive.github.io/visual-vocabulary/){target="_blank"}
[consider which data relationship is most important in your story]{.body-text-s}
:::
...
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "horst-cont-disc.png"))
```
...
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "horst-nom-org-binary.png"))
```
...
## {#practice-sasquatch data-menu-title="Practice sasquatch"}

[Practice - Sasquatch]{.slide-title}

<hr>

::: {.center-text}
You’re a dedicated Squatcher gearing up for your next Bigfoot research expedition. Luckily, you have access to a comprehensive database of Bigfoot sightings across North America (yes, this exists; see [BFRO](https://www.bfro.net/){target="_blank"} & [TidyTuesday (Sep 13, 2022)](https://github.com/rfordatascience/tidytuesday/tree/main/data/2022/2022-09-13){target="_blank"}). **You want to explore how sightings differ by season** so you can time your search for peak Bigfoot activity.
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "bigfoot.png"))
```

::: {.footer}
Image source: [UC Berkeley](https://alumni.berkeley.edu/california-magazine/online/so-why-do-people-believe-bigfoot-anyway/){target="_blank"}
:::

```{r countdown-sasquatch}
countdown::countdown(
  minutes = 3,
  # left = 0, right = 0,
  # Fanfare when it's over
...
## {#practice-water-quality data-menu-title="Practice water quality"}

[Practice - Water Quality]{.slide-title}

<hr>


::: {.center-text}
You’re a microbiologist tasked with advising beachgoers in Sydney, Australia on which beaches are safest for swimming. You have collected ocean temperature (°C) and Enterococci bacteria levels (CFUs per 100 mL) at all major Sydney beaches multiple times a day, every day since 1991 (see this [TidyTuesday dataset from Mar 20, 2025](https://github.com/rfordatascience/tidytuesday/blob/main/data/2025/2025-05-20/readme.md){target="_blank"}). **You want to understand how water temperature is related to bacteria levels, and whether this relationship differs by beach,** so that you can provide more nuanced safety recommendations.
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "sydney-beach.jpeg"))
```

::: {.footer}
Image source: [CNN](https://www.cnn.com/travel/article/australia-best-beaches){target="_blank"}
:::

```{r countdown-water-quality}
countdown::countdown(
  minutes = 3,
  # left = 0, right = 0,
  # Fanfare when it's over
...
[3. Try multiple different graphic forms]{.slide-title}

<hr>

If we want to show both big picture patterns and detailed comparisons, we may **consider including multiple graphic forms.**

<br>

<!-- THROWING ERROR THAT I CAN'T EXPLAIN SO ADDING CODE HERE -->
<!-- {{< include sections/county-precip.qmd >}} -->


```{r choropleth-wrangle}
#| eval: true
#| echo: false
#| message: false
#| warning: false
...
precip_data <- read_csv(here::here("course-materials", "data", "lecture", "county-nov20-oct25-precip.csv"), skip = 3)
...
base_map <- ggplot(joined_precip_geom) +
  ...
  labs(title = "5-year precipitation compared to the 20th century average",
       subtitle = "November 2020 - October 2025",
...
joined_precip_geom |>
  ...
  slice_max(n = 10, order_by = precip) |>
  ...
  labs(x = "", y = "Total Precipitation (inches)",
       title = "California counties with the highest cumulative rainfall (Nov 2020 - Oct 2025)") +
  theme_classic() +
  theme(
...
::: {.notes}
Consider how easy / difficult comparing precipitation across a subset of counties might be using only color to encode data.
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "cairo-advertising-v1.png"))
```
:::
...
Images from [Alberto Cairo's *The Truthful Art*](https://www.albertocairo.com/){target="_blank"}
:::
:::

```{r countdown-in-theater-ads}
countdown::countdown(
  minutes = 1,
  # left = 0, right = 0,
  # Fanfare when it's over
...
::: {.column width="50%"}
```{r in-theater-ads-rearranged}
#| eval: true
#| echo: false
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "cairo-advertising-v2.png"))
```
:::
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "sonderegger-fed-spending1.png"))
```
...
::: footer
::: {.center-text .gray-text}
Example from Derek L. Sonderegger's online textbook, [STA 141 - Exploratory Data Analysis and Visualization](https://bookdown.org/dereksonderegger/141/){target="_blank"}
:::
:::
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "sonderegger-fed-spending2.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("images/week2/wilkes-a.png")
```

::: footer
::: {.center-text .gray-text}
Example from Claus Wilke's, [Fundamentals of Data Visualization](https://clauswilke.com/dataviz/visualizing-amounts.html){target="_blank"}
:::
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("images/week2/wilkes-b.png")
```
...
#| fig-align: "center"
#| out-width: "65%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "iraq-deaths.png"))
```

::: {.center-text .gray-text .body-text-s}
Source: [Iraq's bloody toll](https://www.scmp.com/infographics/article/1284683/iraqs-bloody-toll){target="_blank"}, by [Simon Scarr](https://www.simonscarr.com/){target="_blank"}
:::
...
```{r gun-deaths-original}
#| eval: true
#| echo: false
#| fig-align: "center"
#| out-width: "75%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "gun-deaths-original.png"))
```

::: {.center-text .gray-text .body-text-s}
Source: [This Chart Shows An Alarming Rise In Florida Gun Deaths After 'Stand Your Ground' Was Enacted](https://www.businessinsider.com/gun-deaths-in-florida-increased-with-stand-your-ground-2014-2){target="_blank"}.
:::
...
```{r countdown-gun-deaths-original}
countdown::countdown(
  minutes = 2,
  # left = 0, right = 0,
  # Fanfare when it's over
...
Critique by Alberto Cairo in his post [In visualization, baselines and negative space matter](http://www.thefunctionalart.com/2014/04/in-visualization-baselines-and-negative.html){target="_blank"} (NOTE 2025-01-10: link broken, haven't found replacement)
:::
:::
...
Business Insider [published](https://www.businessinsider.com/gun-deaths-in-florida-increased-with-stand-your-ground-2014-2){target="_blank"} an updated graphic (originally designed by Reuters), which was submitted by a reader that, **"more clearly shows that gun deaths increased between 2005 and 2007 by flipping the y-axis"**:
...
::: {.column width="50%"}
```{r gun-deaths-revised}
#| eval: true
#| echo: false
#| fig-align: "center"
#| out-width: "65%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "gun-deaths-revised.png"))
```
:::
