...
::: {.right-align-text}
-[Richard H. Thaler](https://www.chicagobooth.edu/faculty/directory/t/richard-h-thaler){target="_blank"}, economist & professor
:::
...
joined_precip_geom |>
  ...
  labs(x = "", y = "Total Precipitation (inches)",
       title = "California counties with the highest rainfall (Nov 2020 - Oct 2025)") +
  theme_classic() +
  theme(
