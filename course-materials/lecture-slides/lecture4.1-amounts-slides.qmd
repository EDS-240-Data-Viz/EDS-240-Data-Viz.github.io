...
[2. lollipop plots]{.body-text-m} (and dot plot variant)
...
[4. dumbbell plots]{.body-text-m} (for visualizing change / difference between two groups)
...
[We'll use these data to explore: **(1) occupations with the highest median earnings (<sup>1</sup>across males and females)? (2) how earnings change across years for different occupations (3) How median earnings differ between males and females within occupations?**]{.body-text-s}
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/week4/ca-bar.png")
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/week4/ca-lollipop.png")
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/week4/ca-dot.png")
```
:::
...
Let's say we want to **explore the difference in median salaries between male and female workers, by occupation**. We can use a dumbbell (aka Cleveland) plot to display median salaries by female (numeric) and male (numeric) workers, by occupation (categorical):
