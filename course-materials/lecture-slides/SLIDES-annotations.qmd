...
#| eval: false
#| echo: true
#| code-line-numbers: "28-34,41-44,58-77"
#......................create color palette......................
pal <- c("avail" = "#448F9C",
         "consum" = "#9C7344",
         "dark_gray" = "#0C1509",
...
## {#ggsave-png data-menu-title="ggsave() png"} 

[You may need to make adjustments, depending on size]{.slide-title3}
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "water-plot-8x7.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "water-plot-14x9.png"))
```
