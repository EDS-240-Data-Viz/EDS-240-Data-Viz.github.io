...
#| fig-align: "center"
#| out-width: "60%"
knitr::include_graphics("images/week1/ggplot2.png")
```
:::
...
<!-- -from Hadley Wickham’s [A layered grammar of graphics](https://doi.org/10.1198/jcgs.2009.07098){target="_blank"} in *Journal of Computational and Graphical Statistics*, vol. 19, no. 1 pp. 3-28, 2010. -->
<!-- ::: -->
...
<!-- ::: {.right-align-text .body-text-s} -->
<!-- -from Liz Sander’s post [Telling stories with data using the grammar of graphics](https://codewords.recurse.com/issues/six/telling-stories-with-data-using-the-grammar-of-graphics){target="_blank"} -->
<!-- ::: -->
...
knitr::include_graphics("images/week1/horst-tidy-data-friends.png")
```
...
knitr::include_graphics("images/week1/horst-tidy-data-definition.png")
```
...
knitr::include_graphics("images/week1/horst-untidy-data.png")
```
...
#| fig-align: "center"
#| out-width: "50%"
knitr::include_graphics("images/week1/untidy-multi-obs-per-row.png")
```
...
knitr::include_graphics("images/week1/horst-workbench.png")
```
...
#| fig-align: "center"
#| out-width: "70%"
knitr::include_graphics("images/week1/core-tidyverse.png")
```
...
#| fig-align: "center"
#| out-width: "55.5%"
knitr::include_graphics("images/week1/r4ds-cover.png")
```
...
knitr::include_graphics("images/week1/palmer-penguins.png")
```
...
#| fig-align: "center"
#| out-width: "60%"
knitr::include_graphics("images/week1/scherer-evo-ggplot.gif")
```
...
<!-- [**End-of-class Survey #1 (EOC #1)** -- *Due [Mon 01/08]{.magenta-text} at 11:55pm*]{.body-text-m} -->

<!-- - 2 multiple choice + 2 short answer + 1 optional question -->

<!-- . . .  -->

<!-- [**Pre-course Reflection (SR #1)** -- *Due [Sat 01/13]{.magenta-text} at 11:59pm*]{.body-text-m} -->

<!-- - 3 sets of questions about school & life, the way you learn best, learning goals, some fun stuff -->

<!-- . . .  -->

<!-- [**Homework Assignment #1 (HW #1)** -- *Due [Sat 01/20]{.magenta-text} at 11:59pm*]{.body-text-m} -->
