...
<!-- #| echo: false -->
<!-- ggsave( -->
<!--   filename = here::here("course-materials", "lecture-slides", "images", "week6", "salary_plot_8x7.png"), -->
<!--   plot = updated_plot, -->
<!--   device = "png", -->
<!--   width = 8,  -->
<!--   height = 7, -->
...
<!-- ggsave( -->
<!--   filename = here::here("course-materials", "lecture-slides", "images", "week6", "salary_plot_8x7_ragg.png"), -->
<!--   plot = updated_plot, -->
<!--   device = ragg::agg_png(), -->
<!--   width = 8,  -->
<!--   height = 7, -->
...
::: {.center-text}
Saving ggplots with external fonts can still be surprisingly tricky....
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/week6/salary_plot_8x7.png")
```
