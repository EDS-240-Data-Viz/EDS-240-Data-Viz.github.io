...
This code should look familiar (copied from [Lecture 4.1](lecture4.1-amounts-slides.qmd){target="_blank"}):
...
This code was copied from [Lecture 4.1](lecture4.1-amounts-slides.qmd){target="_blank"}. Resulting plot is rendered on the next slide!
