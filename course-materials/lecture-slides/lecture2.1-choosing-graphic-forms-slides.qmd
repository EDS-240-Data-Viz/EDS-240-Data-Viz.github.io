...
Albert Cairo's visualization of the scores from Thaler's exam case study, from [The Truthful Art](https://www.amazon.com/gp/product/0321934075/){target="_blank"}
:::
...
::: {.right-align-text}
-Albert Cairo^1^, in his book, [*The Truthful Art*](https://www.amazon.com/Truthful-Art-Data-Charts-Communication/dp/0321934075){target="_blank"}
:::
...
[[Albert Cairo's recreation](https://badriadhikari.github.io/data-viz-workshop-2021/activity-perceptual-task/Solution.html){target="_blank"} of Cleveland & McGill's Hierarchy of Elementary Perceptual Tasks {{< fa arrow-right title="an arrow pointing to the right" >}}]{.body-text-s .gray-text}
...
Images from [Albert Cairo's *The Truthful Art*](https://www.albertocairo.com/){target="_blank"}
:::
:::
...
::: {.center-text .gray-text .body-text-s}
Source: [Iraq's bloody toll](https://www.scmp.com/infographics/article/1284683/iraqs-bloody-toll){target="_blank"}.
:::
...
Critique by Albert Cairo in his post [In visualization, baselines and negative space matter](http://www.thefunctionalart.com/2014/04/in-visualization-baselines-and-negative.html){target="_blank"}
:::
:::
