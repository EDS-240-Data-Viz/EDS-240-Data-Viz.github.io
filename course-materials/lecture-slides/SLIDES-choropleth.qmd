...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "geopandas-choropleth.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "hanna-farnsworth-2013.png"))
```
...
#| out-width: "60%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "ncei-logo1.png"))
```
:::
...
#| out-width: "70%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "tigris.png"))
```
...
**Use an [unclassed]{.teal-text} color scale if you want to [show general patterns]{.teal-text}:** <img src="../images/lecture-slides/unclassed.png" alt="An unclassed color scale with colors that smoothly transition from dark green on the left to dark red on the right." style="display: inline-block; margin: 0; position: relative; top: 3px; width:80px;height:20px;"/>
...
Recall [from earlier](SLIDES-colors.qmd#climate-palettes){target="_blank"} that precipitation data is often encoded using a **brown / blue** color scheme (with drier conditions falling on the brown side and wetter conditions falling on the blue side). 
...
```{r powerful-multiples}
#| eval: true
#| echo: false
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "nyt-precip.png"))
```
