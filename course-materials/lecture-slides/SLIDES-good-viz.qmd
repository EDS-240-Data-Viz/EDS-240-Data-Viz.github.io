...
Highlight data by coloring groups of interest either manually or by using helpful packages, like `{gghighlight}` (we saw an example of this in the [visualizing evolution](SLIDES-evolution.qmd#spaghetti-plot){target="_blank"}):
