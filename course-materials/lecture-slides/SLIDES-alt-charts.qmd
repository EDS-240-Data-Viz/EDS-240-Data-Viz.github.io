...
[*Alternative chart type practice (waffle & bump charts)*]{.custom-subtitle}
...
[Choose one of the prior two examples to recreate:]{.body-text-l}
...
::: {.center-text}
*Templates are available on the [week 9 course website page](../week9.qmd). Keys will be shared after class.*
:::
