...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "ggplot-example.png"))
```
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "gganimate-example.gif"))
```
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "shiny-example.gif"))
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "lascaux1.png"))
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "lascaux2.png"))
``` 
:::
::::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "turin-papyrus.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "quipu.png"))
```
...
#| out-width: "90%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "toledo-rome.png"))
```
...
#| out-width: "90%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "playfair-bar.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "temple-of-time.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "minard.png"))
```

<br>

::: {.footer}
Source: [Wikipedia](https://en.wikipedia.org/wiki/Charles_Joseph_Minard){target="_blank"}; also check out this [Closeread scrollytelling rendition](https://closeread.dev/gallery/examples/minards-map/){target="_blank"}
...
#| out-width: "50%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "DuBois-anyene.png"))
```
...
#| out-width: "50%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "DuBois-freites.png"))
```
...
::: {.center-text}
The emergence of programming languages and tools in recent years has made data visualization design easier than every before.
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "modern-viz-tools.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "ripple-etal-2023-fig1.png"))
```
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "diamond-hist.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "cars-boxplot.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "diamonds-freqplot.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "anscombes-quartet.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "datasaurus-dozen.gif"))
```
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "lipponen-anomalies.gif"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "sabbarao-climate-spiral.gif"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "bremer-patchwork-kingdoms1.png"))
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "bremer-patchwork-kingdoms2.png"))
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "bremer-patchwork-kingdoms3.png"))
```
:::
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "scherer-space-travel.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "anyene-astronauts.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "thompson-astronauts.png"))
```
...
::: {.incremental}
- [great ecosystem of data wrangling & visualization packages (inc. a massive and growing collection of `{ggplot2}` extensions)]{.body-text-m}
- [amazing online learning communities]{.body-text-m}
- [data viz fundamentals apply no matter the language / tool]{.body-text-m}
:::
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("course-materials", "images", "lecture-slides", "why-r.png"))
```
:::
