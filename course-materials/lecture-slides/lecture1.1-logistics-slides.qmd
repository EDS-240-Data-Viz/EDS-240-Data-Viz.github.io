...
- **trade "tokens"** for the opportunity to:         
    ...
    - to miss class (though see [sickness & emergency policy](https://docs.google.com/document/d/1ZALT0Ef9GQga5rkBAWJhzQ2npC4l-FkcNV4kMYFud0Q/edit?tab=t.0#heading=h.n2jxepxnwrym))
...
::: {.center-text .body-text-l}
**Please read the full policy on the [course syllabus](https://docs.google.com/document/d/1ZALT0Ef9GQga5rkBAWJhzQ2npC4l-FkcNV4kMYFud0Q/edit?tab=t.0)**
:::
