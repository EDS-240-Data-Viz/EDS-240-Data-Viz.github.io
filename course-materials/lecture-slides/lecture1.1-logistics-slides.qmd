...
**Learn more:** [samanthacsik.github.io](https://samanthacsik.github.io/){target="_blank"}
...
Link is also bookmarked at the top of the **#eds-240-data-viz** Slack channel and linked on the [Courses page](https://ucsb-meds.github.io/courses.html){target="_blank"} of the MEDS website.
:::
...
| 8   | 2/24    | data storytelling, people as data                                    |
| 9   | 3/03    | OJS with Dr. Allison Horst                                           |
...
Fill out this Google form: [https://forms.gle/TzD7ihnuK9vbnQbb6](https://forms.gle/TzD7ihnuK9vbnQbb6){target="_blank"} and email Sam & Sloane to let them know
...
::: {.center-text .body-text-l}
**Please read the full policy on the [course syllabus](https://docs.google.com/document/d/1ZALT0Ef9GQga5rkBAWJhzQ2npC4l-FkcNV4kMYFud0Q/edit?tab=t.0){target="_blank"}**
:::
...
Check out the [getting unstuck](../../getting-unstuck.qmd){target="_blank"} page (under "resources") on the course website for more tips -- particularly a reminder of **how to ask a question.**
