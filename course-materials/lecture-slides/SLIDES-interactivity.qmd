...
- Keep the same alt text formula discussed previously :[**Chart type**]{.teal-text} of [**type of data**]{.magenta-text} where [**reason for including chart**]{.dark-blue-text}.  If suitable, include interactive context by adding a sentence like this to the end of your alt text: 
