...
precip_data <- read_csv(here::here("course-materials", "lecture-slides", "data", "county-feb19-jan24-precip.csv"), 
                        skip = 4)
...
joined_precip_geom |>
  ...
  labs(x = "", y = "Total Precipitation (inches)",
       title = "Top 10 California counties to recieve the most rainfall, Feb 2019 - Jan 2024") +
  theme_classic() +
  theme(
