...
precip_data <- read_csv(here::here("course-materials", "lecture-slides", "data", "county-nov20-oct25-precip.csv"), skip = 3)

# "county-feb19-jan24-precip.csv"
...
df <- joined_precip_geom |>
  filter(state == "California") |>
  mutate(county = str_remove(county, " County")) |>
  slice_max(n = 10, order_by = precip)


ggplot(df, aes(x = reorder(county, precip), y = precip)) +
