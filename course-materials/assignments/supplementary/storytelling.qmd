...
[Storytelling for data science bloggers]{.custom-title}

[*Tips for crafting your EDS 240 final project*]{.custom-subtitle}

<hr class="hr-teal">

[[FPM #4](../FPM4.qmd){target="_blank"}]{.custom-subtitle3}
...
::: {.footer}
A screenshot from my Google Analytics dashboard. My most highly-visited page is consistently [this blog post](https://samanthacsik.github.io/posts/2022-10-24-quarto-blogs/){target="_blank"}.
:::
...
[And you can drive engagement by promoting your posts]{.slide-title}
...
::: {.footer}
A screenshot from my Google Analytics dashboard. Views peaked when I [shared my blog post on LinkedIn](https://www.linkedin.com/feed/update/urn:li:activity:7181031975984488449/){target="_blank"}. 
:::
...
[. . . but with practice throughout MEDS, I hope you'll find *blogging* to be:]{.body-text-m}
...
[Data science blogging can (and should) be more than just the code you've written or the tool you've learned -- this is what we'll (primarily) focus on here.]{.body-text-m}
...
[For EDS 240, that topic is **chosen for you** (though beyond class, you'll have **full creative freedom** -- consider leaning on your [personal brand](https://docs.google.com/presentation/d/1vhRnICrX_i1tarCA3rHrpNgpteckC5VX_nZQxMjyAM8/edit){target="_blank"} to help guide your blog post topics).]{.body-text-m}

<br>

[Reference the [final project instructions]((../final-project.qmd)){target="_blank"} to remind youself of the goals for this blog post.]{.body-text-m}
...
::: {.footer}
From [Alex Phillips'](https://www.alexandraatleephillips.com/){target="_blank"} [ESM 438](https://bren.ucsb.edu/courses/esm-438){target="_blank"} course materials
:::
...
::: {.footer}
Freytag's Pyramid is just one possible narrative structure. From [Alex Phillips'](https://www.alexandraatleephillips.com/){target="_blank"} [ESM 438](https://bren.ucsb.edu/courses/esm-438){target="_blank"} course materials
:::
...
::: {.footer}
Adapted from [Alex Phillips'](https://www.alexandraatleephillips.com/) [ESM 438](https://bren.ucsb.edu/courses/esm-438){target="_blank"} course materials and [this article on Freytag's Pyramid](https://nofilmschool.com/freytag-s-pyramid){target="_blank"}
:::
...
::: {.footer}
Adapted from [Alex Phillips'](https://www.alexandraatleephillips.com/){target="_blank"} [ESM 438](https://bren.ucsb.edu/courses/esm-438){target="_blank"} course materials and [this article on Freytag's Pyramid](https://nofilmschool.com/freytag-s-pyramid){target="_blank"}
:::
...
::: {.footer}
This storytelling / scene-setting all occurs in the intro / conclusion of my blog post, [Why create presentations slides bout blogging when you can just blog about it instead?](https://samanthacsik.github.io/posts/2021-09-21-distill-blogs/){target="_blank"}
:::
...
::: {.footer}
Source: [Uniting science and stories: Perspectives on the value of storytelling for communicating science](https://www.facetsjournal.com/doi/full/10.1139/facets-2016-0079#sec-3{target="_blank"}) (Green et al. 2018); See additional examples of some of the many other possible [narrative structures](https://www.campfirewriting.com/learn/narrative-structure){target="_blank"}.
:::
...
[**From [My First Live Coding Interview](https://maya.rbind.io/posts/live-coding-interview/){target="_blank"}, by [Maya Gans](https://maya.rbind.io/){target="_blank"}:**]{.body-text-m}
...
::: {.body-text-s}
>*"Around 11pm last night I saw [this tweet](https://x.com/tcarpenter216/status/1580771753873518593){target="_blank"} [SCREENSHOT OF TWEET]. Tom’s instinct makes perfect sense. My first thought was “[CHICKEN WINGS.”](https://www.businessinsider.com/restaurants-pricing-confusing-math-2018-10){target="_blank"} So I spent a couple sleepless hours with this weird (and obviously fake) data set about bird attacks in 1974, because it felt like a good October distraction and an opportunity to get some data wrangling rust off."* **-[Allison Horst](https://allisonhorst.github.io/){target="_blank"}, in [1974…bird attacks?](https://allisonhorst.github.io/posts/2022-10-14-bird-attacks/){target="_blank"}**
:::

::: {.body-text-s}
>*"Hello and welcome back to my multi-part series about what I like to call slidecrafting; The art of putting together slides that are functional and aesthetically pleasing. I will be using [quarto presentations](https://quarto.org/){target="_blank"}. This is the fifth post, you can find all other posts in the [slidecraft 101](https://emilhvitfeldt.com/project/slidecraft-101/){target="_blank"} project."* **-[Emil Hvitfeldt](https://emilhvitfeldt.com/){target="_blank"}, in [Slidecraft 101: Layout](https://emilhvitfeldt.com/post/slidecraft-layout/){target="_blank"}**
:::
...
[[Matt Dray](https://www.matt-dray.com/){target="_blank"} and [Adriana De Palma](https://adrianadepalma.com/){target="_blank"}'s blog, [rostrum.blog](https://www.rostrum.blog/){target="_blank"} is one that often (always?) leverages embellishments to engage their readers. Examples from their post, **[Base slaps!](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/){target="_blank"}**, on the following slides.]{.body-text-m}

::: {.footer}
The following slide content is adapted from [Alex Phillips'](https://www.alexandraatleephillips.com/){target="_blank"} [ESM 438](https://bren.ucsb.edu/courses/esm-438){target="_blank"} course materials, with the added example of [Base Slaps!](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/){target="_blank"}.
:::
...
Matt opens his abstract for [this talk](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/#video){target="_blank"} (under the section titled, [Premise](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/#premise){target="_blank"}) with the hook:
...
::: {.footer}
Both quotes and [xkcd adaptation](https://xkcd.com/2347/){target="_blank"} come from the section titled, [Content](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/#content){target="_blank"}. Find many more metaphors and media throughout the [blog post](https://www.rostrum.blog/posts/2023-10-17-nhs-r-2023/){target="_blank"}.
:::
...
[**Getting feedback:**]{.body-text-l}


- [Trade with a friend (even better if you can both give feedback to one another)]{.body-text-m}

- [See us at student hours!]{.body-text-m}

- [Opportunity to receive, incorporate and address feedback through FPM #4 revision & resubmission]{.body-text-m}
...
<div class="vertical-center center-text">
<p class="custom-subtitle bottombr">{{< fa plus title="a plus sign" >}} A few final tips to consider, as appropriate</p>
</div>
...
::: {.footer}
H/T: [Julie Lowndes](https://openscapes.org/team){target="_blank"} for recommending using TL;DRs in blog posts! I gave it a shot for the first time in my post, [Porting the Openscapes website from blogdown to Quarto](https://samanthacsik.github.io/posts/2023-08-01-openscapes-website/){target="_blank"}.
:::
...
Most visitors won't read your entire blog post, but rather want to jump to the parts that are relevant for them -- help them easily navigate by creating clear section headers (e.g. `#` - `####`) and enabling a [table of contents](https://quarto.org/docs/reference/formats/html.html#table-of-contents){target="_blank"}.
...
::: {.footer}
Set `toc: true` in either your `_quarto.yml` file (which would make this the default behavior across *all* your website pages), or in your blog post's YAML (which turns on table of contents for *just* that page). You may also adjust the `toc-depth` (number of section levels to include; defaults to 3). Screenshot from my blog post, [Building (and teaching) a graduate-level data science course](https://samanthacsik.github.io/posts/2024-04-02-data-viz-course/#building-the-course){target="_blank"}
:::
...
***[FPM #4](../FPM4.qmd){target="_blank"} details where you should include your code chunk and how to set the code chunk options. Please follow the instructions for your EDS 240 blog post (but consider the above for other / future posts!).***
...
[If your blog post contains code, make sure it's easily readable and generally pleasant to look at:]{.body-text-m}

<br>

- use logical variable / object names
- include clear, succinct, and nicely structured code annotations, as appropriate (check out the [`{ARTofR}` package](https://github.com/Hzhang-ouce/ARTofR){target="_blank"})
- consider [*folding* code](https://quarto.org/docs/output-formats/html-code.html#folding-code){target="_blank"} so that readers can expand / collapse code as needed (set `code-fold: true` in your post's YAML, or on a chunk-by-chunk basis)
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/mkochuten.png")
```
:::
...
<br>
<br>
[Check out [Marina Kochuten](https://mwidas.github.io/){target="_blank"}' (MEDS 2024) post, [Relationship between bee behavior and vineyard types in Germany](https://mwidas.github.io/blog-posts/2024-03-05-infographic-bees-wine/){target="_blank"}, which demonstrates the above approaches (Melissa also does a great job telling a story in her intro).]{.body-text-s}
:::
:::: -->
...
[Add [category](https://quarto.org/docs/websites/website-blog.html#categories){target="_blank"} tags to individual blog posts to strategically group related posts. Some ideas / examples:]{.body-text-m}
...
::: {.footer}
**Note:** I prefer using CSS for styling and aligning my figure captions. See [this example image caption](https://github.com/samanthacsik/samanthacsik.github.io/blob/main/posts/2024-04-02-data-viz-course/index.qmd#L72){target="_blank"} and the associated CSS rules ([1](https://github.com/samanthacsik/samanthacsik.github.io/blob/061b2e1986f718307b56ca16017af74eab2f8730/styles.scss#L134){target="_blank"} & [2](https://github.com/samanthacsik/samanthacsik.github.io/blob/061b2e1986f718307b56ca16017af74eab2f8730/styles.scss#L118){target="_blank"}).
:::
