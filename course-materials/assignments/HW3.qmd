...
subtitle: "Assigned Mon 02/10/2025 | Due Sat 02/22/2025"
---
...
::: {.callout-tip}
## Tip: Remember to check out the [Resources page](../resources.qmd){target="_blank"}!!
It lists tons of really wonderful websites, tutorials, and links to the repos / websites of some seriously incredible [data viz creators](../resources.qmd#inspirational-data-visualization-creators){target="_blank"}. This is an excellent place to start when looking for inspiration.
:::
