...
subtitle: "Assigned Mon 01/06/2025 | Due Sat 03/08/2025"
---
...
[**You will also share your data design process and decisions in a short, 1-2 page (~500-1,000 words) science communication blog post-style write up. Your writing should:**]{.teal-text}
...
2. A published Quarto document that is deployed using GitHub Pages
...
You will have 3 minutes to present your final data visualization(s). You must address the following in your presentation: 

- [ ] the question(s) you set out to answer with your visualization(s)
- [ ] your data source(s)
- [ ] your intended audience
- [ ] two key insights from your visualization -- these should focus on what your audience should take away from the data
- [ ] two design choices (e.g. colors, typography, graphic form, layout) that helped to shape the visualization(s) and improve communication for your intended audience
- [ ] 1-2 challenges that you encountered during this project, and how you addressed / iterated on these issues
- [ ] one thing that your especially proud of completing / learning / accomplishing for this project

::: {.callout-important}
## **IMPORTANT:** 
These are in-person presentations, held during finals week. Make-up presentations will not be permitted. Please plan accordingly!
:::
...
- [ ] Add the link to your published Quarto doc / blog post to [this Google Sheet](https://docs.google.com/spreadsheets/d/1VizY_Yc1m_EwudpIHcCPHlFIo8BIXyoQzlcFg7FhRiw/edit?usp=sharing){target="_blank"} by Saturday, 03/08/2025 11:59pm.
