...
4. Include the all code used to generate your final data viz products in a collapsible code chunk (see code chunk option, [`code-fold: true`](https://quarto.org/docs/output-formats/html-code.html#folding-code){target="_blank"}) at the end of your blog post. Your code should: 
...
Final project presentations will take place **in person during finals week**. You will have 3 minutes to present your final data visualization(s). You must address the following in your presentation: 
...
- [ ] My code is appropriately organized, formatted, and annotated, and all of my code chunks have the appropriate chunk options specified.
- [ ] I have added the URL to my blog post-style write up to [this Google Sheet](https://docs.google.com/spreadsheets/d/1VizY_Yc1m_EwudpIHcCPHlFIo8BIXyoQzlcFg7FhRiw/edit?usp=sharing){target="_blank"} by Saturday, 03/08/2025 11:59pm. I have also verified that the URL works (e.g. I don't receive a 404 error when I try to open it).
