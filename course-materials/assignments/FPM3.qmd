...
- [ ] **Include all three code-based visualizations (Part IV).** These do not need to be in their perfect final form, but you should strive for complete visualizations as best you can. At a miminum, they should include any necessary text, appropriately-applied color(s), and updated themes. If you're unable to figure out how to implement pieces of these visualizations successfully using code, be sure to describe in writing where you're headed. All code used to build your visualizations must be visible in your rendered PDF (e.g. make sure code chunks remain expanded).
- [ ] **Code in Part IV should follow appropriate styling conventions and include clear, informative annotations.** You don’t need to explain every line, but your annotations should make it easy to follow your thinking and understand important decisions in your code.
- [ ] **Answer all Part V questions.** There are no strict length requirements for free-response questions, however we expect that you answer them thoughtfully and fully.
- [ ] **Ensure that everything described above is included in your neatly-organized and polished `drafting-viz.qmd`** -- this includes appropriate document YAML (at a minimum, title, author, date), clearly labeled sections, appropriately-formatted prose, appropriate code chunk options (e.g. code should render and execute, but warnings and messages should be suppressed, long data frames should not be printed out, etc.)
- [ ] **Render `drafting-viz.qmd` as a PDF.** Double check that all of your outputs, code, and prose are visible.
- [ ] **Upload your PDF to Gradescope** by 11:59pm on 02/25/2026.
