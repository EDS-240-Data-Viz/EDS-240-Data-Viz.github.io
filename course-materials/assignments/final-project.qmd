...
::: {.callout-important}
This document outlines the overarching goals and outcomes of your EDS 240 Final Project. You will develop these final deliverables incrementally through multiple assignments (HW #2, HW #4, HW #6, HW #7, HW #8). Each of these assignments will be include detailed instructions and rubric specifications.
:::
