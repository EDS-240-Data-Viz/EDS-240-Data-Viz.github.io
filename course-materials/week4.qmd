...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 4.1: visualizing amounts / rankings](lecture-slides/lecture4.1-amounts-slides.qmd){target="_blank"}  | [4.1 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/week4/TEMPLATE-lecture4.1-rankings.qmd){target="_blank"} | [4.1 key](keys/KEY-lecture4.1-rankings.qmd){target="_blank"} |
