...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 7.1: typography](lecture-slides/SLIDES-typography.qmd){target="_blank"}  | [7.1 & 7.2 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-typography.qmd){target="_blank"} | [7.1 & 7.2 key](keys/KEY-typography-annotations.qmd){target="_blank"} |
