...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 7.1: typography](lecture-slides/SLIDES-typography.qmd){target="_blank"}  | [7.1 & 7.2 + lab template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-typography.qmd){target="_blank"} | [7.1 & 7.2 + lab key](keys/KEY-typography-annotations.qmd){target="_blank"} |
...
::: {.callout-important}
## TODO
- move "saving ggplots" lab materials from week 6 to week 7 to complete in first ~20min; reserve remaining time for peer review
...
|-------------------|-------------------|--------------|
| [Lab 7 slides: saving ggplots](lab/LAB-SLIDES-saving-ggplots.qmd){target="_blank"} | *NA* | [7.1 & 7.2 + lab key](keys/KEY-typography-annotations.qmd){target="_blank"} (same as lecture key) |
