...
::: {.callout-important}
## TODO
- new lab content should include writing alt text + finding data (for FPM #1)
:::
...
|-------------------|-------------------|--------------|
| [Lab 2 slides: Alt Text](lab/LAB-SLIDES-alt-text.qmd){target="_blank"} | [Lab 2 exercise: writing alt text](lab/LAB-EXERCISE-alt-text.qmd){target="_blank"} | [Lab 2 solution](lab/LAB-SOLUTION-alt-text.qmd){target="_blank"} |
