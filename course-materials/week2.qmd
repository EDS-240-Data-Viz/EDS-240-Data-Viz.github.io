...
*Image from [Amy Cesal](https://www.amycesal.com/){target="_blank"}'s article, [Writing Alt Text for Data Visualization](https://medium.com/nightingale/writing-alt-text-for-data-visualization-2a218ef43f81){target="_blank"}, published in [Nightingale](https://medium.com/nightingale){target="_blank"}. You'll practice writing alt text in this week's lab session.*
:::
...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 2.1: choosing graphic form](lecture-slides/SLIDES-choosing-graphic-form.qmd){target="_blank"}  | *NA* | *NA* |
| [Lecture 2.2: visualizing distributions](lecture-slides/SLIDES-distributions.qmd){target="_blank"} | [2.2 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-distributions.qmd){target="_blank"} | [2.2 key](keys/KEY-distributions.qmd){target="_blank"} |
...
::: {.callout-important}
## TODO
- new lab content should include writing alt text (currently linked to week 3) + finding data (for FPM #1)
:::
...
|-------------------|-------------------|--------------|
| [Lab 2 slides: USDM](lab/LAB-SLIDES-usdm-graphic-form.qmd){target="_blank"} | [Lab 2 exercise: recreate USDM viz](lab/LAB-EXERCISE-usdm-graphic-form.qmd){target="_blank"} | [Lab 2 solution](lab/LAB-SOLUTION-usdm-graphic-form.qmd){target="_blank"} |
