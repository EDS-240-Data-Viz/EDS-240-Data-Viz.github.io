...
|-------------------|-------------------|--------------|
| [Lab 2 slides: Alt Text](lab/LAB-SLIDES-alt-text.qmd){target="_blank"} | [Lab 2 exercise: writing alt text](lab/LAB-EXERCISE-alt-text-activity.qmd){target="_blank"} | [Lab 2 solution](){target="_blank"} |
