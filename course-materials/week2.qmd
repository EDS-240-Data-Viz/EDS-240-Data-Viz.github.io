...
2. **Add your API key to your `.Renviron` file**. For security purposes, you should *NEVER* push any API keys to GitHub. Rather than typing our API key into any of our scripts, we can instead save it to our `.Renviron` file. Follow these steps:
...
[Dotfiles](https://en.wikipedia.org/wiki/Hidden_file_and_hidden_directory){target="_blank"} are hidden files (preceded by a dot, `.`), which are broadly used to customize the behavior of programs. You may already be familiar with some dotfiles, such as other `.gitconfig` and `.gitignore`.

**The `.Renviron` file is an R-specific dotfile, which is commonly used for (though not limited to) storing sensitive information, such as API keys.** It lives in your computer's home directory (e.g. `/Users/yourUserName` on macOS, or `C:/Users/yourUserName/Documents` on Windows), and is automatically sourced when an R session starts. When sourced, all stored variables (such as your API key) are made available to your R environment for you to use.
:::
...
add more instructions about data wrangling review
:::
...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 2.1: choosing graphic forms](lecture-slides/lecture2.1-choosing-graphic-forms-slides.qmd){target="_blank"}  | *NA* | *NA* |
| [Lecture 2.2: visualizing distributions](lecture-slides/lecture2.2-distributions-slides.qmd){target="_blank"}  | [2.2 template](){target="_blank"} | [2.2 key](keys/KEY-lecture2.2-distributions.qmd){target="_blank"} |
| [Lecture 2.3: visualizing evolution](lecture-slides/lecture2.3-evolution-slides.qmd){target="_blank"}  | 2.3 template | [2.3 key](keys/KEY-lecture2.3-evolution.qmd){target="_blank"} |
...
<!-- | Assignment Type | Assignment Title                                  | Date Assigned  | Date Due                   | -->
<!-- |-----------------|---------------------------------------------------|----------------|----------------------------| -->
<!-- | EOC             | [EOC (week 2)](https://forms.gle/G5DbEAxKCxyaCZyB8)  | Mon 01/13/2024 | Mon 01/13/2024, 11:55pm PT | -->
<!-- | HW              | [Homework Assignment #1](assignments/HW1.qmd)  | Mon 01/06/2025 | Sat 01/18/2025, 11:59pm PT | -->
<!-- : {.hover .bordered tbl-colwidths="[20,30,20,30]"}  -->
