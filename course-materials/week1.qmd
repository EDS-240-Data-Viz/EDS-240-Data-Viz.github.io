...
| [Lecture 1.3: `{ggplot2}` review](lecture-slides/lecture1.3-ggplot-review-slides.qmd){target="_blank"}  | [1.3 template](https://github.com/EDS-240-Data-Viz/EDS-240-Data-Viz.github.io/blob/main/course-materials/templates/TEMPLATE-lecture1.3-ggplot-review.qmd){target="_blank"} | [1.3 key](keys/KEY-lecture1.3-ggplot-review.qmd){target="_blank"} |
...
These data were originally downloaded as a [zip file](https://drive.google.com/file/d/1XUW-660tXKhxTl0tSkWFqtvaJcRedD7r/view?usp=sharing) from [FracFocus](https://fracfocus.org/data-download){target="_blank"} in November 2023 when they were still quite messy. Since then, FracFocus has published cleaner versions of these data, which is great, but also defeats the purpose of this exercise {{< fa face-smile title="a smiling face" >}}. For this reason, we'll be working with this saved version of the data, rather than downloading directly from [FracFocus's data download page](https://fracfocus.org/data-download).
:::
...
|-------------------|-------------------|--------------|
| [D1 slides: data wrangling](discussion/week1/week1-wrangling-slides.qmd) | [D1 exercise: wrangle fracking data](discussion/week1/week1-exercise.qmd) | [D1 solution](discussion/week1/week1-solution.qmd) |
