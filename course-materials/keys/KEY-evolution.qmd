---
title: "KEY - visualizing evolution"
author: "Your Name"
date: 2026-01-21
toc: true
---
...
::: {.callout-note}
This template follows the [visualizing evolution slides](../lecture-slides/SLIDES-evolution.qmd){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
<!-- Just print this chunk (with file path that students will use) -->
