...
::: {.callout-note}
This key follows the [`{ggplot2}` review slides](../lecture-slides/SLIDES-ggplot-review.qmd){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
```{r}
#| warning: false
# scatterplot with custom continuous colors ----
...
```{r}
#| warning: false
# plscatterplotot with all blue points ----
