...
See lecture 4.1 slides [#4](../lecture-slides/lecture4.1-rankings-slides.qmd#job-data){target="_blank"}, [#5](../lecture-slides/lecture4.1-rankings-slides.qmd#data-wrangling){target="_blank"}, & [#17](../lecture-slides/lecture4.1-rankings-slides.qmd#dumbbell-plot-subset){target="_blank"} as reminders of where we left off.
...
```{r}
# ggsave(
#   filename = here::here("course-materials", "discussion", "week6", "images", "salary-plot-thu.png"),
#   plot = salary_plot,
#   width = 8,
#   height = 7
# )
