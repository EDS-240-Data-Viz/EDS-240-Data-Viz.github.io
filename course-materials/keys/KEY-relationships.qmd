...
::: {.callout-note}
This template follows the [relationships slides](../lecture-slides/SLIDES-relationships.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
