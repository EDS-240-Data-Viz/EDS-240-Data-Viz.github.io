---
title: "KEY- visualizing relationships"
author: "Your Name"
date: 2026-01-28
toc: true
---
...
::: {.callout-note}
This template follows the [relationships lecture](../lecture-slides/SLIDES-relationships.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
#......................add a smoothed line.......................
stream_chem_data |> 
  dplyr::filter(waterYr %in% c(2014:2024)) |> 
...
```{r overplotting-init-strategies}
#| eval: true
#| echo: true
#| warning: false
#| layout-ncol: 3
