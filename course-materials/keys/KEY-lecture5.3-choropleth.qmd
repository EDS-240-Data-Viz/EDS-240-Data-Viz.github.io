...
::: {.callout-note}
This template follows [lecture 5.3 slides](../lecture-slides/lecture5.3-choropleth-slides.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::

## Setup

{{< include ../lecture-slides/sections/5.3-choropleth.qmd >}}
