...
::: {.callout-note}
Recall our original dumbbell plot from the [amounts / rankings lecture](../lecture-slides/SLIDES-amounts-rankings.qmd#dumbbell-plot-example){target="_blank"}. Here, we'll focus on adding text and updating our theme and fonts.
:::
