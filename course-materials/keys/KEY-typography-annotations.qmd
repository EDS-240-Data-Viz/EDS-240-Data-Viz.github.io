---
title: "KEY - typography, annotations & saving ggplots"
author: "Your Name"
date: 2026-02-18
toc: true
editor_options: 
...
::: {.callout-note}
This template follows the [typography](../lecture-slides/SLIDES-typography.qmd){target="_blank"} & [annotations](../lecture-slides/SLIDES-annotations.qmd){target="_blank"} slides, as well as the [saving ggplots lab](../lab/LAB-SLIDES-saving-ggplots.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
We'll build out this plot across both the [typography](../lecture-slides/SLIDES-typography.qmd){target="_blank"} & [annotations](../lecture-slides/SLIDES-annotations.qmd){target="_blank"} lectures, as well as make modifications during the [saving ggplots lab](../lab/LAB-SLIDES-saving-ggplots.qmd).
...
#| echo: false
ggsave(
  filename = here::here("course-materials", "images", "keys", "sbc-hydro-8x7-new.png"),
  plot = water_plot,
  device = "png",
  width = 8, 
  height = 7,
