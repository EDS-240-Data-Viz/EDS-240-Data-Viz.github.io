...
::: {.callout-note}
This key follows the [visualizing-distributions slides](../lecture-slides/SLIDES-distributions.qmd){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
