---
title: "Lecture 10.1 KEY"
subtitle: "Misc. chart types"
author: "Your Name"
date: 2025-03-10
toc: true
editor_options: 
...
::: {.callout-note}
This template follows [lecture 10.1 slides](../lecture-slides/lecture10.1-misc-charts-slides.qmd){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
showtext_auto(FALSE)
```
1. Set `make_proportional = TRUE` (`FALSE` by default)
