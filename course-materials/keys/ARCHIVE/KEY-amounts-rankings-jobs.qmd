...
::: {.callout-note}
This template follows [lecture 4.1 slides](../lecture-slides/lecture4.1-amounts-slides.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
