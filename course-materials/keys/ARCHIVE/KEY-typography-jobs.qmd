...
::: {.callout-note}
This template follows the [typography lecture](../../lecture-slides/SLIDES-typography.qmd){target="_blank"}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
::: {.callout-note}
## Recall our original plot from the [amounts / rankings lecture](../../lecture-slides/ARCHIVE/SLIDES-amounts-rankings-jobs.qmd){target="_blank"}
...
See [amounts / rankings lecture](../../lecture-slides/ARCHIVE/SLIDES-amounts-rankings-jobs.qmd){target="_blank"} as a reminder of where we left off.
...
See [amounts / rankings lecture](../../lecture-slides/ARCHIVE/SLIDES-amounts-rankings-jobs.qmd){target="_blank"} as a reminder.
