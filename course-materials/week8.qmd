...
- [1974…bird attacks?](){target="_blank"}, by Allison Horst -- a blog post that demos a whole bunch of cool skills, but perhaps most relevantly, data wrangling in R then data viz using Observable Plot (and how to do so in Quarto doc `{ojs}` cells)
