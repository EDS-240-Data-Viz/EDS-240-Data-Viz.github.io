...
2. Copy over the contents from your `TEMPLATE-lecture6.1-typography.qmd` file -- we'll be iterating on this code during lab section.
...
|-------------------|-------------------|--------------|
| [Lab 6 slides: saving plots](lab/week6/week6-slides.qmd){target="_blank"} | *see pre-lab prep* | *see L6 slides* |
