...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|
| [Lecture 9.1: alternative chart types](lecture-slides/SLIDES-alt-charts.qmd){target="_blank"}  | [9.1 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-alt-charts.qmd){target="_blank"} | [10.1 key](keys/KEY-alt-charts.qmd){target="_blank"} |
...
|-------------------|-------------------|--------------|
| [Lab 9 slides: critiquing data viz](lab/week9/week9-slides.qmd){target="_blank"} | *NA* | *NA* |
