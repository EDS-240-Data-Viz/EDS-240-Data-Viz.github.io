...
| [Lecture 9.2: alternative chart types](lecture-slides/SLIDES-alt-charts.qmd){target="_blank"} | [9.2 template](https://github.com/EDS-240-Data-Viz/code-along-templates/blob/main/TEMPLATE-alt-charts.qmd){target="_blank"} | *coming soon* |
