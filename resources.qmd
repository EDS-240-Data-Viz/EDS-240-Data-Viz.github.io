...
- **[The Art of Data Visualization with ggplo2: The TidyTuesday Cookbook](https://nrennie.rbind.io/art-of-viz/), by [Nicola Rennie](https://nrennie.rbind.io/)** -- a collection of Nicola's many *incredible* TidyTuesday creations, with detailed explantions of her creative process and code
...
- **[Visual Vocabulary](https://ft-interactive.github.io/visual-vocabulary/), inspired by the Graphic Continuum by Jon Schwabish and Severino Ribecca** -- a helpful tool for choosing the right chart type based on the data relationship most important in your story
...
- **[Closeread Gallery](https://closeread.dev/gallery/)** -- A curated collection of 18 winning and runner-up entries from the Closeread Competition, plus feature demos showcasing what the framework is capable of. All scrollytelling stories include full source code, making it a great place to learn by example.
- **[Learn Closeread](https://www.gastonsanchez.com/learn-closeread/modules/)**-- A structured, multi-module course by Gaston Sanchez that walks you through Closeread from the ground up. Covers everything from installation and basic setup to layout options, focus effects, styling, and building complete scrollytelling stories using text, images, equations, and plots.
- **[CAUSE Student Data Scrollytelling Contest](https://www.causeweb.org/cause/contests/data-scrollytelling)** -- A student competition run by CAUSE (Consortium for the Advancement of Undergraduate Statistics Education) challenging participants to tell compelling data-driven stories through scrollytelling. A good place to find inspiration, see what students are making, or consider entering yourself.
- **[Scrollytelling Examples](https://nrennie.rbind.io/scrollytelling/), by Nicola Rennie** -- A small collection of polished Closeread scrollytelling stories by data visualisation specialist Nicola Rennie, covering topics like a reimagined Gapminder animation, English monarchs and their marriages, and a lightning talk built with Closeread's zoom features. All source code is available on GitHub.
...
- Bannister HJ, Blackwell PG, Hyder K, Webb TJ (2021) **Improving the visual communication of environmental model projections.** Scientific Reports. 11, 19157. <https://doi.org/10.1038/s41598-021-98290-4>
...
- **[Dataviz Universe](https://blog.yan-holtz.com/), by Yan Holtz** -- a weekly, actionable tip about data viz
- **[Dataviz Inspiration](https://www.dataviz-inspiration.com/)** -- a large collection of really awesome data viz examples  
...
- [Kelsey Nanan](https://kan317.wixsite.com/website)
...
- **[`{tidycensus}` package](https://walker-data.com/tidycensus/)** – tooling that allows R users to more easily interface with a select number of the [US Census Bureau](https://www.census.gov/)'s data APIs and return tidyverse-ready data frames
 - **[ERDDAP Datasets](https://www.ncei.noaa.gov/erddap/info/index.html?page=1&itemsPerPage=1000)** -- [ERDDAP™](https://coastwatch.pfeg.noaa.gov/erddap/index.html) (by NOAA) is a scientific data server that gives users a simple, consistent way to download subsets of gridded and tabular scientific datasets in common file formats and make graphs and maps. 
  - **[CalCOFI Data Portal](https://calcofi.org/data/)** -- CalCOFI conducts quarterly cruises off southern & central California to collect a suite of environmental and marine ecosystem data. These data are used to study the California Current, manage its living resources, and monitor the indicators of El Niño and climate change.

### scientific / research data {#research-data}
- **[Nature Scientific Data](https://www.nature.com/sdata/)** - an open-access, online-only journal for descriptions of scientifically valuable datasets; check out the "Subject" dropdown menu to filter for domain-specific data sets (e.g. there's a subsection for Earth and environmental sciences)
